        ...
        private void ResolveIK()
        {
            ...
            if (Pole != null)
            {
                ...
                for (int i = 1; i < Positions.Length - 1; i++)
                {
                    ...
                    var projectedPole = ClosestPointOnPlane(plane, polePosition);
                    var projectedBone = ClosestPointOnPlane(plane, Positions[i]);
                    var angle = SignedAngle(projectedBone - Positions[i - 1], projectedPole - Positions[i - 1], plane.normal);
