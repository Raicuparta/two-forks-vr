...
{
    public static class TwoForksVrPatcher
    {
        private const string dataDirectory = "Firewatch_Data";
        
        // Called by BepInEx
        public static void Initialize()
        {
            var executablePath = Assembly.GetExecutingAssembly().Location;
            var gameManagersPath = Path.Combine(Path.Combine(executablePath, dataDirectory), "globalgamemanagers");
            var patchersPath = Path.Combine(Path.Combine(Path.Combine(executablePath, "BepInEx"), "patchers"), "TwoForksVr");
        ...
        private static void Cleanup(string gamePath)
        {
            ...
            // var dataPath = Path.Combine(gamePath, dataDirectory);
