...
public static class SDKBridge
{
    ...
    private static SDKInjection<SDKInputFrame> _injection_SDKInputFrame = new()
    {
        active = false,
        action = null,
    ...
    private static SDKInjection<SDKResolution> _injection_SDKResolution = new()
    {
        active = false,
        action = null,
    ...
    private static readonly SDKInjection<bool> _injection_IsActive = new()
    {
        active = false,
        action = null,
        data = false
